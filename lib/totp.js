...
export function buildOtpAuthUri(secretBase32, accountLabel, issuer = 'ozy.fi') {
...
export async function generateTotpCode(secretBase32, atTimeMs = Date.now()) {
...
export async function verifyTotpCode(secretBase32, code, atTimeMs = Date.now()) {
