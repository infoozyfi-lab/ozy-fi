...
Object.defineProperty = function(o, p, a) {
  ...
  globalThis.openNextDebug = false;globalThis.openNextVersion = "4.1.4";globalThis.nextVersion = "14.2.5";
...
var require_prerender_manifest = __commonJS({
  ".next/prerender-manifest.js"() {
    self.__PRERENDER_MANIFEST = '{"version":4,"routes":{"/icon.png":{"initialHeaders":{"cache-control":"public, immutable, no-transform, max-age=31536000","content-type":"image/png","x-next-cache-tags":"_N_T_/layout,_N_T_/icon.png/layout,_N_T_/icon.png/route,_N_T_/icon.png"},"experimentalBypassFor":[{"type":"header","key":"Next-Action"},{"type":"header","key":"content-type","value":"multipart/form-data;.*"}],"initialRevalidateSeconds":false,"srcRoute":"/icon.png","dataRoute":null},"/manifest.webmanifest":{"initialHeaders":{"cache-control":"public, max-age=0, must-revalidate","content-type":"application/manifest+json","x-next-cache-tags":"_N_T_/layout,_N_T_/manifest.webmanifest/layout,_N_T_/manifest.webmanifest/route,_N_T_/manifest.webmanifest"},"experimentalBypassFor":[{"type":"header","key":"Next-Action"},{"type":"header","key":"content-type","value":"multipart/form-data;.*"}],"initialRevalidateSeconds":false,"srcRoute":"/manifest.webmanifest","dataRoute":null},"/robots.txt":{"initialHeaders":{"cache-control":"public, max-age=0, must-revalidate","content-type":"text/plain","x-next-cache-tags":"_N_T_/layout,_N_T_/robots.txt/layout,_N_T_/robots.txt/route,_N_T_/robots.txt"},"experimentalBypassFor":[{"type":"header","key":"Next-Action"},{"type":"header","key":"content-type","value":"multipart/form-data;.*"}],"initialRevalidateSeconds":false,"srcRoute":"/robots.txt","dataRoute":null},"/admin/dashboard":{"experimentalBypassFor":[{"type":"header","key":"Next-Action"},{"type":"header","key":"content-type","value":"multipart/form-data;.*"}],"initialRevalidateSeconds":false,"srcRoute":"/admin/dashboard","dataRoute":"/admin/dashboard.rsc"},"/admin/kitchen":{"experimentalBypassFor":[{"type":"header","key":"Next-Action"},{"type":"header","key":"content-type","value":"multipart/form-data;.*"}],"initialRevalidateSeconds":false,"srcRoute":"/admin/kitchen","dataRoute":"/admin/kitchen.rsc"},"/admin":{"experimentalBypassFor":[{"type":"header","key":"Next-Action"},{"type":"header","key":"content-type","value":"multipart/form-data;.*"}],"initialRevalidateSeconds":false,"srcRoute":"/admin","dataRoute":"/admin.rsc"}},"dynamicRoutes":{},"notFoundRoutes":[],"preview":{"previewModeId":"process.env.__NEXT_PREVIEW_MODE_ID","previewModeSigningKey":"process.env.__NEXT_PREVIEW_MODE_SIGNING_KEY","previewModeEncryptionKey":"process.env.__NEXT_PREVIEW_MODE_ENCRYPTION_KEY"}}';
  }
});
...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[826], { 67: (e) => {
      ...
      r.r(b), r.d(b, { config: () => eG, middleware: () => eB });
      let v = null;
      function w() {
        return v || (v = m()), v;
      }
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      function P(e2) {
        let t2 = {}, r2 = [];
        if (e2) for (let [n2, o2] of e2.entries()) "set-cookie" === n2.toLowerCase() ? (r2.push(...function(e3) {
          ...
          for (; s2 < e3.length; ) {
            for (t3 = s2, i2 = false; l2(); ) if ("," === (r3 = e3.charAt(s2))) {
              for (n3 = s2, s2 += 1, l2(), o3 = s2; s2 < e3.length && "=" !== (r3 = e3.charAt(s2)) && ";" !== r3 && "," !== r3; ) s2 += 1;
              s2 < e3.length && "=" === e3.charAt(s2) ? (i2 = true, s2 = o3, a2.push(e3.substring(t3, n3)), t3 = s2) : s2 = n3 + 1;
            } else s2 += 1;
            (!i2 || s2 >= e3.length) && a2.push(e3.substring(t3, e3.length));
          }
          return a2;
        }(o2)), t2[n2] = 1 === r2.length ? r2[0] : r2) : t2[n2] = o2;
        return t2;
      }
      function O(e2) {
        try {
      ...
      let R = Symbol("response"), C = Symbol("passThrough"), N = Symbol("waitUntil");
      class T {
        constructor(e2) {
          this[N] = [], this[C] = false;
        }
      ...
      function A(e2, t2) {
        ...
        let { pathname: r2, query: n2, hash: o2 } = M(e2);
        return "" + t2 + r2 + n2 + o2;
      }
      function L(e2, t2) {
        if (!e2.startsWith("/") || !t2) return e2;
      ...
      class U {
        constructor(e2, t2, r2) {
          let n2, o2;
          "object" == typeof t2 && "pathname" in t2 || "string" == typeof t2 ? (n2 = t2, o2 = r2 || {}) : o2 = r2 || t2 || {}, this[V] = { url: $(e2, n2 ?? o2.base), options: o2, basePath: "" }, this.analyze();
        }
        analyze() {
          var e2, t2, r2, n2, o2;
          let i2 = function(e3, t3) {
            ...
            o3 && k(s3.pathname, o3) && (s3.pathname = function(e4, t4) {
            ...
            if (i3) {
              let e4 = t3.i18nProvider ? t3.i18nProvider.analyze(s3.pathname) : j(s3.pathname, i3.locales);
              s3.locale = e4.detectedLocale, s3.pathname = null != (n3 = e4.pathname) ? n3 : s3.pathname, !e4.detectedLocale && s3.buildId && (e4 = t3.i18nProvider ? t3.i18nProvider.analyze(l2) : j(l2, i3.locales)).detectedLocale && (s3.locale = e4.detectedLocale);
            }
            return s3;
          }(this[V].url.pathname, { nextConfig: this[V].options.nextConfig, parseData: true, i18nProvider: this[V].options.i18nProvider }), a2 = function(e3, t3) {
            let r3;
          ...
          this[V].domainLocale = this[V].options.i18nProvider ? this[V].options.i18nProvider.detectDomainLocale(a2) : function(e3, t3, r3) {
          ...
          }(null == (t2 = this[V].options.nextConfig) ? void 0 : null == (e2 = t2.i18n) ? void 0 : e2.domains, a2);
          let s2 = (null == (r2 = this[V].domainLocale) ? void 0 : r2.defaultLocale) || (null == (o2 = this[V].options.nextConfig) ? void 0 : null == (n2 = o2.i18n) ? void 0 : n2.defaultLocale);
        ...
        formatPathname() {
          ...
          return t2 = function(e3, t3, r2, n2) {
            ...
            return !n2 && (k(o2, "/api") || k(o2, "/" + t3.toLowerCase())) ? e3 : A(e3, "/" + t3);
          }((e2 = { basePath: this[V].basePath, buildId: this[V].buildId, defaultLocale: this[V].options.forceLocale ? void 0 : this[V].defaultLocale, locale: this[V].locale, pathname: this[V].url.pathname, trailingSlash: this[V].trailingSlash }).pathname, e2.locale, e2.buildId ? void 0 : e2.defaultLocale, e2.ignorePrefix), (e2.buildId || !e2.trailingSlash) && (t2 = I(t2)), e2.buildId && (t2 = L(A(t2, "/_next/data/" + e2.buildId), "/" === e2.pathname ? "index.json" : ".json")), t2 = A(t2, e2.basePath), !e2.buildId && e2.trailingSlash ? t2.endsWith("/") ? t2 : L(t2, "/") : I(t2);
        }
        formatSearch() {
        ...
        set locale(e2) {
          var t2, r2;
          if (!this[V].locale || !(null == (r2 = this[V].options.nextConfig) ? void 0 : null == (t2 = r2.i18n) ? void 0 : t2.locales.includes(e2))) throw TypeError(`The NextURL configuration includes no locale "${e2}"`);
          this[V].locale = e2;
        }
        get defaultLocale() {
        ...
        clone() {
          return new U(String(this), this[V].options);
        }
      }
      var q = r(447);
      ...
      class G extends Request {
        constructor(e2, t2 = {}) {
          ...
          let n2 = new U(r2, { headers: P(this.headers), nextConfig: t2.nextConfig });
      ...
      class W extends Response {
        constructor(e2, t2 = {}) {
          super(e2, t2), this[H] = { cookies: new q.ResponseCookies(this.headers), url: t2.url ? new U(t2.url, { headers: P(this.headers), nextConfig: t2.nextConfig }) : void 0 };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
        ...
        static redirect(e2, t2) {
          ...
          return o2.set("Location", O(e2)), new W(null, { ...n2, headers: o2, status: r2 });
        }
      ...
      r(387);
      let Y = { client: "client", server: "server", edgeServer: "edge-server" };
      Y.client, Y.server, Y.edgeServer, Symbol("polyfills");
      let Z = ["__nextFallback", "__nextLocale", "__nextInferredLocaleFromDefault", "__nextDefaultLocale", "__nextIsNotFound", "_rsc"], J = ["__nextDataReq"], Q = "nxtP", ee = { shared: "shared", reactServerComponents: "rsc", serverSideRendering: "ssr", actionBrowser: "action-browser", api: "api", middleware: "middleware", instrument: "instrument", edgeAsset: "edge-asset", appPagesBrowser: "app-pages-browser", appMetadataRoute: "app-metadata-route", appRouteHandler: "app-route-handler" };
      ...
      }(c || (c = {})), (d || (d = {})).executeRoute = "Router.executeRoute", (p || (p = {})).runHandler = "Node.runHandler", (f || (f = {})).runHandler = "AppRouteRouteHandlers.runHandler", function(e2) {
        e2.generateMetadata = "ResolveMetadata.generateMetadata", e2.generateViewport = "ResolveMetadata.generateViewport";
      }(g || (g = {})), (h || (h = {})).execute = "Middleware.execute";
      let ef = ["Middleware.execute", "BaseServer.handleRequest", "Render.getServerSideProps", "Render.getStaticProps", "AppRender.fetch", "AppRender.getBodyResult", "Render.renderDocument", "Node.runHandler", "AppRouteRouteHandlers.runHandler", "ResolveMetadata.generateMetadata", "ResolveMetadata.generateViewport", "NextNodeServer.createComponentTree", "NextNodeServer.findPageComponents", "NextNodeServer.getLayoutOrPageModule", "NextNodeServer.startResponse", "NextNodeServer.clientComponentLoading"], eg = ["NextNodeServer.findPageComponents", "NextNodeServer.createComponentTree", "NextNodeServer.clientComponentLoading"], { context: eh, propagation: eb, trace: em, SpanStatusCode: ev, SpanKind: ew, ROOT_CONTEXT: ey } = n = r(692), e_ = (e2) => null !== e2 && "object" == typeof e2 && "function" == typeof e2.then, eS = (e2, t2) => {
      ...
      }, ex = /* @__PURE__ */ new Map(), eP = n.createContextKey("next.rootSpanId"), eO = 0, eR = () => eO++;
      class eC {
        getTracerInstance() {
        ...
        withPropagatedContext(e2, t2, r2) {
          ...
          let o2 = eb.extract(n2, e2, r2);
          return eh.with(o2, t2);
        }
        trace(...e2) {
          var t2;
          let [r2, n2, o2] = e2, { fn: i2, options: a2 } = "function" == typeof n2 ? { fn: n2, options: {} } : { fn: o2, options: { ...n2 } }, s2 = a2.spanName ?? r2;
          if (!ef.includes(r2) && "1" !== process.env.NEXT_OTEL_VERBOSE || a2.hideSpan) return i2();
          ...
          let c2 = eR();
          return a2.attributes = { "next.span_name": s2, "next.span_type": r2, ...a2.attributes }, eh.with(l2.setValue(eP, c2), () => this.getTracerInstance().startActiveSpan(s2, a2, (e3) => {
            let t3 = "performance" in globalThis ? globalThis.performance.now() : void 0, n3 = () => {
              ex.delete(c2), t3 && process.env.NEXT_OTEL_PERFORMANCE_PREFIX && eg.includes(r2 || "") && performance.measure(`${process.env.NEXT_OTEL_PERFORMANCE_PREFIX}:next-${(r2.split(".").pop() || "").replace(/[A-Z]/g, (e4) => "-" + e4.toLowerCase())}`, { start: t3, end: performance.now() });
            };
            u2 && ex.set(c2, new Map(Object.entries(a2.attributes ?? {})));
            try {
        ...
        wrap(...e2) {
          ...
          return ef.includes(r2) || "1" === process.env.NEXT_OTEL_VERBOSE ? function() {
            ...
            {
              let n3 = t2.getContext().bind(eh.active(), a2);
        ...
        getSpanContext(e2) {
          return e2 ? em.setSpan(eh.active(), e2) : void 0;
        }
        getRootSpanAttributes() {
          let e2 = eh.active().getValue(eP);
          return ex.get(e2);
        }
      }
      let eN = (() => {
      ...
      class eE {
        constructor(e2, t2, r2, n2) {
          ...
          }(t2, e2).isOnDemandRevalidate, a2 = null == (o2 = r2.get(eT)) ? void 0 : o2.value;
      ...
      let eI = { wrap(e2, { req: t2, res: r2, renderOpts: n2 }, o2) {
        let i2;
        function a2(e3) {
        ...
        let s2 = {}, l2 = { get headers() {
          ...
          }(t2.headers, (null == n2 ? void 0 : n2.onUpdateCookies) || (r2 ? a2 : void 0))), s2.mutableCookies;
        }, get draftMode() {
          return s2.draftMode || (s2.draftMode = new eE(i2, t2, this.cookies, this.mutableCookies)), s2.draftMode;
      ...
      let eL = { keys: (e2) => Array.from(e2.keys()), get: (e2, t2) => e2.get(t2) ?? void 0 }, ek = (e2, t2) => eN().withPropagatedContext(e2.headers, t2, eL), ej = false;
      async function eD(e2) {
        ...
        let o2 = void 0 !== self.__BUILD_MANIFEST, i2 = "string" == typeof self.__PRERENDER_MANIFEST ? JSON.parse(self.__PRERENDER_MANIFEST) : void 0;
        ...
        let u2 = function(e3) {
          ...
          return t3;
        }(e2.request.headers), c2 = /* @__PURE__ */ new Map();
        if (!o2) for (let e3 of X) {
        ...
        let d2 = new eA({ page: e2.page, input: function(e3, t3) {
          ...
          for (let e4 of Z) n3.searchParams.delete(e4);
          if (t3) for (let e4 of J) n3.searchParams.delete(e4);
          return r2 ? n3.toString() : n3;
        }(a2, true).toString(), init: { body: e2.request.body, geo: e2.request.geo, headers: u2, ip: e2.request.ip, method: e2.request.method, nextConfig: e2.request.nextConfig, signal: e2.request.signal } });
        l2 && Object.defineProperty(d2, "__isData", { enumerable: false, value: true }), !globalThis.__incrementalCache && e2.IncrementalCache && (globalThis.__incrementalCache = new e2.IncrementalCache({ appDir: true, fetchCache: true, minimalMode: true, fetchCacheKeyPrefix: "", dev: false, requestHeaders: e2.request.headers, requestProtocol: "https", getPrerenderManifest: () => ({ version: -1, routes: {}, dynamicRoutes: {}, notFoundRoutes: [], preview: { previewModeId: "development-id" } }) }));
        let p2 = new E({ request: d2, page: e2.page });
        if ((t2 = await ek(d2, () => "/middleware" === e2.page || "/src/middleware" === e2.page ? eN().trace(h.execute, { spanName: `middleware ${d2.method} ${d2.nextUrl.pathname}`, attributes: { "http.target": d2.nextUrl.pathname, "http.method": d2.method } }, () => eI.wrap(eM, { req: d2, renderOpts: { onUpdateCookies: (e3) => {
          n2 = e3;
        }, previewProps: (null == i2 ? void 0 : i2.preview) || { previewModeId: "development-id", previewModeEncryptionKey: "", previewModeSigningKey: "" } } }, () => e2.handler(d2, p2))) : e2.handler(d2, p2))) && !(t2 instanceof Response)) throw TypeError("Expected an instance of Response to be returned");
        t2 && n2 && t2.headers.set("set-cookie", n2);
        let f2 = null == t2 ? void 0 : t2.headers.get("x-middleware-rewrite");
        if (t2 && f2 && !o2) {
          let r2 = new U(f2, { forceLocale: true, headers: e2.request.headers, nextConfig: e2.request.nextConfig });
          r2.host === d2.nextUrl.host && (r2.buildId = s2 || r2.buildId, t2.headers.set("x-middleware-rewrite", String(r2)));
          let n3 = K(String(r2), String(a2));
        ...
        if (t2 && g2 && !o2) {
          ...
          t2 = new Response(t2.body, t2), r2.host === d2.nextUrl.host && (r2.buildId = s2 || r2.buildId, t2.headers.set("Location", String(r2))), l2 && (t2.headers.delete("Location"), t2.headers.set("x-nextjs-redirect", K(String(r2), String(a2))));
        }
        let b2 = t2 || W.next(), m2 = b2.headers.get("x-middleware-override-headers"), v2 = [];
        if (m2) {
          for (let [e3, t3] of c2) b2.headers.set(`x-middleware-request-${e3}`, t3), v2.push(e3);
          v2.length > 0 && b2.headers.set("x-middleware-override-headers", m2 + "," + v2.join(","));
        }
        return { response: b2, waitUntil: Promise.all(p2[N]), fetchMetrics: d2.fetchMetrics };
      }
      r(568), "undefined" == typeof URLPattern || URLPattern;
      var e$ = r(571);
      "This order was cancelled of that\u2019s unexpected, please call us.".replace("of that", "If that"), (e2) => `Last updated: ${e2}`;
      let eV = ["fi", "en"];
      function eU(e2) {
        return eV.includes(e2);
      }
      let eq = "ozy_locale";
      function eB(e2) {
        let { pathname: t2, search: r2 } = e2.nextUrl, n2 = t2.split("/")[1];
        if (eU(n2)) {
          let e3 = W.next();
          return e3.cookies.set(eq, n2, { path: "/", maxAge: 31536e3, sameSite: "lax" }), e3;
        }
        let o2 = e2.cookies.get(eq)?.value, i2 = eU(o2) ? o2 : "fi", a2 = e2.nextUrl.clone();
        return a2.pathname = `/${i2}${"/" === t2 ? "" : t2}`, a2.search = r2, W.redirect(a2, 308);
      }
      let eG = { matcher: ["/((?!api|admin|_next|images|favicon.ico|icon.png|robots.txt|sitemap.xml|manifest.webmanifest).*)"] }, eH = { ...b }, eF = eH.middleware || eH.default, ez = "/middleware";
      if ("function" != typeof eF) throw Error(`The Middleware "${ez}" must export a \`middleware\` or a \`default\` function`);
      function eW(e2) {
        return eD({ ...e2, page: ez, handler: eF });
      }
    }, 447: (e) => {
      "use strict";
      ...
      function l(e2) {
        var t2, r2;
        if (!e2) return;
        let [[n2, o2], ...i2] = s(e2), { domain: a2, expires: l2, httponly: d2, maxage: p2, path: f, samesite: g, secure: h, partitioned: b, priority: m } = Object.fromEntries(i2.map(([e3, t3]) => [e3.toLowerCase(), t3]));
        return function(e3) {
          let t3 = {};
          for (let r3 in e3) e3[r3] && (t3[r3] = e3[r3]);
          return t3;
        }({ name: n2, value: decodeURIComponent(o2), domain: a2, ...l2 && { expires: new Date(l2) }, ...d2 && { httpOnly: true }, ..."string" == typeof p2 && { maxAge: Number(p2) }, path: f, ...g && { sameSite: u.includes(t2 = (t2 = g).toLowerCase()) ? t2 : void 0 }, ...h && { secure: true }, ...m && { priority: c.includes(r2 = (r2 = m).toLowerCase()) ? r2 : void 0 }, ...b && { partitioned: true } });
      }
      ((e2, r2) => {
      ...
      (() => {
        ...
        var t2 = { 491: (e2, t3, r2) => {
          ...
          let n2 = r2(223), o2 = r2(172), i2 = r2(930), a = "context", s = new n2.NoopContextManager();
          class l {
            constructor() {
            }
            static getInstance() {
            ...
            setGlobalContextManager(e3) {
              return (0, o2.registerGlobal)(a, e3, i2.DiagAPI.instance());
            }
            active() {
            ...
            _getContextManager() {
              return (0, o2.getGlobal)(a) || s;
            }
            disable() {
              this._getContextManager().disable(), (0, o2.unregisterGlobal)(a, i2.DiagAPI.instance());
            }
          }
          t3.ContextAPI = l;
        }, 930: (e2, t3, r2) => {
          Object.defineProperty(t3, "__esModule", { value: true }), t3.DiagAPI = void 0;
          let n2 = r2(56), o2 = r2(912), i2 = r2(957), a = r2(172);
          class s {
            constructor() {
              function e3(e4) {
                return function(...t5) {
              ...
              t4.setLogger = (e4, r3 = { logLevel: i2.DiagLogLevel.INFO }) => {
                ...
                let u = (0, a.getGlobal)("diag"), c = (0, o2.createLogLevelDiagLogger)(null !== (s2 = r3.logLevel) && void 0 !== s2 ? s2 : i2.DiagLogLevel.INFO, e4);
          ...
          let n2 = r2(660), o2 = r2(172), i2 = r2(930), a = "metrics";
          class s {
            constructor() {
            }
            static getInstance() {
            ...
            getMeterProvider() {
              return (0, o2.getGlobal)(a) || n2.NOOP_METER_PROVIDER;
            }
            getMeter(e3, t4, r3) {
              return this.getMeterProvider().getMeter(e3, t4, r3);
            }
            disable() {
              (0, o2.unregisterGlobal)(a, i2.DiagAPI.instance());
            }
          }
          t3.MetricsAPI = s;
        }, 181: (e2, t3, r2) => {
          Object.defineProperty(t3, "__esModule", { value: true }), t3.PropagationAPI = void 0;
          let n2 = r2(172), o2 = r2(874), i2 = r2(194), a = r2(277), s = r2(369), l = r2(930), u = "propagation", c = new o2.NoopTextMapPropagator();
          class d {
            constructor() {
          ...
          let n2 = r2(172), o2 = r2(846), i2 = r2(139), a = r2(607), s = r2(930), l = "trace";
          class u {
            constructor() {
              this._proxyTracerProvider = new o2.ProxyTracerProvider(), this.wrapSpanContext = i2.wrapSpanContext, this.isSpanContextValid = i2.isSpanContextValid, this.deleteSpan = a.deleteSpan, this.getSpan = a.getSpan, this.getActiveSpan = a.getActiveSpan, this.getSpanContext = a.getSpanContext, this.setSpan = a.setSpan, this.setSpanContext = a.setSpanContext;
            }
            static getInstance() {
          ...
          let n2 = r2(930), o2 = r2(993), i2 = r2(830), a = n2.DiagAPI.instance();
          ...
          let n2 = r2(200), o2 = r2(521), i2 = r2(130), a = o2.VERSION.split(".")[0], s = Symbol.for(`opentelemetry.js.api.${a}`), l = n2._globalThis;
          t3.registerGlobal = function(e3, t4, r3, n3 = false) {
            var i3;
            let a2 = l[s] = null !== (i3 = l[s]) && void 0 !== i3 ? i3 : { version: o2.VERSION };
            if (!n3 && a2[e3]) {
              let t5 = Error(`@opentelemetry/api: Attempted duplicate registration of API: ${e3}`);
              return r3.error(t5.stack || t5.message), false;
            }
            if (a2.version !== o2.VERSION) {
              let t5 = Error(`@opentelemetry/api: Registration of version v${a2.version} for ${e3} does not match previously registered API v${o2.VERSION}`);
              return r3.error(t5.stack || t5.message), false;
            }
            return a2[e3] = t4, r3.debug(`@opentelemetry/api: Registered a global for ${e3} v${o2.VERSION}.`), true;
          ...
          function i2(e3) {
            ...
            return function(e4) {
              ...
              return null != s.prerelease || i3.major !== s.major ? a(e4) : 0 === i3.major ? i3.minor === s.minor && i3.patch <= s.patch ? (t4.add(e4), true) : a(e4) : i3.minor <= s.minor ? (t4.add(e4), true) : a(e4);
            };
          }
          ...
          let n2 = r2(491), o2 = r2(607), i2 = r2(403), a = r2(139), s = n2.ContextAPI.getInstance();
          class l {
            startSpan(e3, t4, r3 = s.active()) {
              if (null == t4 ? void 0 : t4.root) return new i2.NonRecordingSpan();
              let n3 = r3 && (0, o2.getSpanContext)(r3);
            ...
            startActiveSpan(e3, t4, r3, n3) {
              ...
              2 == arguments.length ? l2 = t4 : 3 == arguments.length ? (i3 = t4, l2 = r3) : (i3 = t4, a2 = r3, l2 = n3);
              let u = null != a2 ? a2 : s.active(), c = this.startSpan(e3, i3, u), d = (0, o2.setSpan)(u, c);
          ...
          class i2 {
            getTracer(e3, t4, r3) {
              var o3;
              return null !== (o3 = this.getDelegateTracer(e3, t4, r3)) && void 0 !== o3 ? o3 : new n2.ProxyTracer(this, e3, t4, r3);
            }
            getDelegate() {
              var e3;
              return null !== (e3 = this._delegate) && void 0 !== e3 ? e3 : o2;
            }
            setDelegate(e3) {
              this._delegate = e3;
            }
          ...
          let n2 = r2(780), o2 = r2(403), i2 = r2(491), a = (0, n2.createContextKey)("OpenTelemetry Context Key SPAN");
          function s(e3) {
          ...
          class o2 {
            ...
            _parse(e3) {
              !(e3.length > 512) && (this._internalState = e3.split(",").reverse().reduce((e4, t4) => {
                ...
                if (-1 !== o3) {
                  let i2 = r3.slice(0, o3), a = r3.slice(o3 + 1, t4.length);
          ...
          let r2 = "[_0-9a-z-*/]", n2 = `[a-z]${r2}{0,255}`, o2 = `[a-z0-9]${r2}{0,240}@[a-z]${r2}{0,13}`, i2 = RegExp(`^(?:${n2}|${o2})$`), a = /^[ -~]{0,255}[!-~]$/, s = /,|=/;
          ...
          let n2 = r2(476), o2 = r2(403), i2 = /^([0-9a-f]{32})$/i, a = /^[0-9a-f]{16}$/i;
          function s(e3) {
        ...
        function o(e2) {
          ...
          try {
            t2[e2].call(i2.exports, i2, i2.exports, o), a = false;
          } finally {
            a && delete n[e2];
          }
          return i2.exports;
        ...
        (() => {
          ...
          Object.defineProperty(i, "trace", { enumerable: true, get: function() {
            return S.trace;
          } }), i.default = { context: v.context, diag: w.diag, metrics: y.metrics, propagation: _.propagation, trace: S.trace };
        })(), e.exports = i;
      })();
    }, 373: (e) => {
      (() => {
      ...
      (() => {
        var o = { 226: function(o2, i2) {
          !function(a2, s2) {
            "use strict";
            var l = "function", u = "undefined", c = "object", d = "string", p = "major", f = "model", g = "name", h = "type", b = "vendor", m = "version", v = "architecture", w = "console", y = "mobile", _ = "tablet", S = "smarttv", x = "wearable", P = "embedded", O = "Amazon", R = "Apple", C = "ASUS", N = "BlackBerry", T = "Browser", E = "Chrome", I = "Firefox", M = "Google", A = "Huawei", L = "Microsoft", k = "Motorola", j = "Opera", D = "Samsung", $ = "Sharp", V = "Sony", U = "Xiaomi", q = "Zebra", B = "Facebook", G = "Chromium OS", H = "Mac OS", F = function(e2, t2) {
              var r2 = {};
              ...
              return e2;
            }, J = { ME: "4.90", "NT 3.11": "NT3.51", "NT 4.0": "NT4.0", 2e3: "NT 5.0", XP: ["NT 5.1", "NT 5.2"], Vista: "NT 6.0", 7: "NT 6.1", 8: "NT 6.2", 8.1: "NT 6.3", 10: ["NT 6.4", "NT 10.0"], RT: "ARM" }, Q = { browser: [[/\b(?:crmo|crios)\/([\w\.]+)/i], [m, [g, "Chrome"]], [/edg(?:e|ios|a)?\/([\w\.]+)/i], [m, [g, "Edge"]], [/(opera mini)\/([-\w\.]+)/i, /(opera [mobiletab]{3,6})\b.+version\/([-\w\.]+)/i, /(opera)(?:.+version\/|[\/ ]+)([\w\.]+)/i], [g, m], [/opios[\/ ]+([\w\.]+)/i], [m, [g, j + " Mini"]], [/\bopr\/([\w\.]+)/i], [m, [g, j]], [/(kindle)\/([\w\.]+)/i, /(lunascape|maxthon|netfront|jasmine|blazer)[\/ ]?([\w\.]*)/i, /(avant |iemobile|slim)(?:browser)?[\/ ]?([\w\.]*)/i, /(ba?idubrowser)[\/ ]?([\w\.]+)/i, /(?:ms|\()(ie) ([\w\.]+)/i, /(flock|rockmelt|midori|epiphany|silk|skyfire|bolt|iron|vivaldi|iridium|phantomjs|bowser|quark|qupzilla|falkon|rekonq|puffin|brave|whale(?!.+naver)|qqbrowserlite|qq|duckduckgo)\/([-\w\.]+)/i, /(heytap|ovi)browser\/([\d\.]+)/i, /(weibo)__([\d\.]+)/i], [g, m], [/(?:\buc? ?browser|(?:juc.+)ucweb)[\/ ]?([\w\.]+)/i], [m, [g, "UC" + T]], [/microm.+\bqbcore\/([\w\.]+)/i, /\bqbcore\/([\w\.]+).+microm/i], [m, [g, "WeChat(Win) Desktop"]], [/micromessenger\/([\w\.]+)/i], [m, [g, "WeChat"]], [/konqueror\/([\w\.]+)/i], [m, [g, "Konqueror"]], [/trident.+rv[: ]([\w\.]{1,9})\b.+like gecko/i], [m, [g, "IE"]], [/ya(?:search)?browser\/([\w\.]+)/i], [m, [g, "Yandex"]], [/(avast|avg)\/([\w\.]+)/i], [[g, /(.+)/, "$1 Secure " + T], m], [/\bfocus\/([\w\.]+)/i], [m, [g, I + " Focus"]], [/\bopt\/([\w\.]+)/i], [m, [g, j + " Touch"]], [/coc_coc\w+\/([\w\.]+)/i], [m, [g, "Coc Coc"]], [/dolfin\/([\w\.]+)/i], [m, [g, "Dolphin"]], [/coast\/([\w\.]+)/i], [m, [g, j + " Coast"]], [/miuibrowser\/([\w\.]+)/i], [m, [g, "MIUI " + T]], [/fxios\/([-\w\.]+)/i], [m, [g, I]], [/\bqihu|(qi?ho?o?|360)browser/i], [[g, "360 " + T]], [/(oculus|samsung|sailfish|huawei)browser\/([\w\.]+)/i], [[g, /(.+)/, "$1 " + T], m], [/(comodo_dragon)\/([\w\.]+)/i], [[g, /_/g, " "], m], [/(electron)\/([\w\.]+) safari/i, /(tesla)(?: qtcarbrowser|\/(20\d\d\.[-\w\.]+))/i, /m?(qqbrowser|baiduboxapp|2345Explorer)[\/ ]?([\w\.]+)/i], [g, m], [/(metasr)[\/ ]?([\w\.]+)/i, /(lbbrowser)/i, /\[(linkedin)app\]/i], [g], [/((?:fban\/fbios|fb_iab\/fb4a)(?!.+fbav)|;fbav\/([\w\.]+);)/i], [[g, B], m], [/(kakao(?:talk|story))[\/ ]([\w\.]+)/i, /(naver)\(.*?(\d+\.[\w\.]+).*\)/i, /safari (line)\/([\w\.]+)/i, /\b(line)\/([\w\.]+)\/iab/i, /(chromium|instagram)[\/ ]([-\w\.]+)/i], [g, m], [/\bgsa\/([\w\.]+) .*safari\//i], [m, [g, "GSA"]], [/musical_ly(?:.+app_?version\/|_)([\w\.]+)/i], [m, [g, "TikTok"]], [/headlesschrome(?:\/([\w\.]+)| )/i], [m, [g, E + " Headless"]], [/ wv\).+(chrome)\/([\w\.]+)/i], [[g, E + " WebView"], m], [/droid.+ version\/([\w\.]+)\b.+(?:mobile safari|safari)/i], [m, [g, "Android " + T]], [/(chrome|omniweb|arora|[tizenoka]{5} ?browser)\/v?([\w\.]+)/i], [g, m], [/version\/([\w\.\,]+) .*mobile\/\w+ (safari)/i], [m, [g, "Mobile Safari"]], [/version\/([\w(\.|\,)]+) .*(mobile ?safari|safari)/i], [m, g], [/webkit.+?(mobile ?safari|safari)(\/[\w\.]+)/i], [g, [m, Z, { "1.0": "/8", 1.2: "/1", 1.3: "/3", "2.0": "/412", "2.0.2": "/416", "2.0.3": "/417", "2.0.4": "/419", "?": "/" }]], [/(webkit|khtml)\/([\w\.]+)/i], [g, m], [/(navigator|netscape\d?)\/([-\w\.]+)/i], [[g, "Netscape"], m], [/mobile vr; rv:([\w\.]+)\).+firefox/i], [m, [g, I + " Reality"]], [/ekiohf.+(flow)\/([\w\.]+)/i, /(swiftfox)/i, /(icedragon|iceweasel|camino|chimera|fennec|maemo browser|minimo|conkeror|klar)[\/ ]?([\w\.\+]+)/i, /(seamonkey|k-meleon|icecat|iceape|firebird|phoenix|palemoon|basilisk|waterfox)\/([-\w\.]+)$/i, /(firefox)\/([\w\.]+)/i, /(mozilla)\/([\w\.]+) .+rv\:.+gecko\/\d+/i, /(polaris|lynx|dillo|icab|doris|amaya|w3m|netsurf|sleipnir|obigo|mosaic|(?:go|ice|up)[\. ]?browser)[-\/ ]?v?([\w\.]+)/i, /(links) \(([\w\.]+)/i, /panasonic;(viera)/i], [g, m], [/(cobalt)\/([\w\.]+)/i], [g, [m, /master.|lts./, ""]]], cpu: [[/(?:(amd|x(?:(?:86|64)[-_])?|wow|win)64)[;\)]/i], [[v, "amd64"]], [/(ia32(?=;))/i], [[v, K]], [/((?:i[346]|x)86)[;\)]/i], [[v, "ia32"]], [/\b(aarch64|arm(v?8e?l?|_?64))\b/i], [[v, "arm64"]], [/\b(arm(?:v[67])?ht?n?[fl]p?)\b/i], [[v, "armhf"]], [/windows (ce|mobile); ppc;/i], [[v, "arm"]], [/((?:ppc|powerpc)(?:64)?)(?: mac|;|\))/i], [[v, /ower/, "", K]], [/(sun4\w)[;\)]/i], [[v, "sparc"]], [/((?:avr32|ia64(?=;))|68k(?=\))|\barm(?=v(?:[1-7]|[5-7]1)l?|;|eabi)|(?=atmel )avr|(?:irix|mips|sparc)(?:64)?\b|pa-risc)/i], [[v, K]]], device: [[/\b(sch-i[89]0\d|shw-m380s|sm-[ptx]\w{2,4}|gt-[pn]\d{2,4}|sgh-t8[56]9|nexus 10)/i], [f, [b, D], [h, _]], [/\b((?:s[cgp]h|gt|sm)-\w+|sc[g-]?[\d]+a?|galaxy nexus)/i, /samsung[- ]([-\w]+)/i, /sec-(sgh\w+)/i], [f, [b, D], [h, y]], [/(?:\/|\()(ip(?:hone|od)[\w, ]*)(?:\/|;)/i], [f, [b, R], [h, y]], [/\((ipad);[-\w\),; ]+apple/i, /applecoremedia\/[\w\.]+ \((ipad)/i, /\b(ipad)\d\d?,\d\d?[;\]].+ios/i], [f, [b, R], [h, _]], [/(macintosh);/i], [f, [b, R]], [/\b(sh-?[altvz]?\d\d[a-ekm]?)/i], [f, [b, $], [h, y]], [/\b((?:ag[rs][23]?|bah2?|sht?|btv)-a?[lw]\d{2})\b(?!.+d\/s)/i], [f, [b, A], [h, _]], [/(?:huawei|honor)([-\w ]+)[;\)]/i, /\b(nexus 6p|\w{2,4}e?-[atu]?[ln][\dx][012359c][adn]?)\b(?!.+d\/s)/i], [f, [b, A], [h, y]], [/\b(poco[\w ]+)(?: bui|\))/i, /\b; (\w+) build\/hm\1/i, /\b(hm[-_ ]?note?[_ ]?(?:\d\w)?) bui/i, /\b(redmi[\-_ ]?(?:note|k)?[\w_ ]+)(?: bui|\))/i, /\b(mi[-_ ]?(?:a\d|one|one[_ ]plus|note lte|max|cc)?[_ ]?(?:\d?\w?)[_ ]?(?:plus|se|lite)?)(?: bui|\))/i], [[f, /_/g, " "], [b, U], [h, y]], [/\b(mi[-_ ]?(?:pad)(?:[\w_ ]+))(?: bui|\))/i], [[f, /_/g, " "], [b, U], [h, _]], [/; (\w+) bui.+ oppo/i, /\b(cph[12]\d{3}|p(?:af|c[al]|d\w|e[ar])[mt]\d0|x9007|a101op)\b/i], [f, [b, "OPPO"], [h, y]], [/vivo (\w+)(?: bui|\))/i, /\b(v[12]\d{3}\w?[at])(?: bui|;)/i], [f, [b, "Vivo"], [h, y]], [/\b(rmx[12]\d{3})(?: bui|;|\))/i], [f, [b, "Realme"], [h, y]], [/\b(milestone|droid(?:[2-4x]| (?:bionic|x2|pro|razr))?:?( 4g)?)\b[\w ]+build\//i, /\bmot(?:orola)?[- ](\w*)/i, /((?:moto[\w\(\) ]+|xt\d{3,4}|nexus 6)(?= bui|\)))/i], [f, [b, k], [h, y]], [/\b(mz60\d|xoom[2 ]{0,2}) build\//i], [f, [b, k], [h, _]], [/((?=lg)?[vl]k\-?\d{3}) bui| 3\.[-\w; ]{10}lg?-([06cv9]{3,4})/i], [f, [b, "LG"], [h, _]], [/(lm(?:-?f100[nv]?|-[\w\.]+)(?= bui|\))|nexus [45])/i, /\blg[-e;\/ ]+((?!browser|netcast|android tv)\w+)/i, /\blg-?([\d\w]+) bui/i], [f, [b, "LG"], [h, y]], [/(ideatab[-\w ]+)/i, /lenovo ?(s[56]000[-\w]+|tab(?:[\w ]+)|yt[-\d\w]{6}|tb[-\d\w]{6})/i], [f, [b, "Lenovo"], [h, _]], [/(?:maemo|nokia).*(n900|lumia \d+)/i, /nokia[-_ ]?([-\w\.]*)/i], [[f, /_/g, " "], [b, "Nokia"], [h, y]], [/(pixel c)\b/i], [f, [b, M], [h, _]], [/droid.+; (pixel[\daxl ]{0,6})(?: bui|\))/i], [f, [b, M], [h, y]], [/droid.+ (a?\d[0-2]{2}so|[c-g]\d{4}|so[-gl]\w+|xq-a\w[4-7][12])(?= bui|\).+chrome\/(?![1-6]{0,1}\d\.))/i], [f, [b, V], [h, y]], [/sony tablet [ps]/i, /\b(?:sony)?sgp\w+(?: bui|\))/i], [[f, "Xperia Tablet"], [b, V], [h, _]], [/ (kb2005|in20[12]5|be20[12][59])\b/i, /(?:one)?(?:plus)? (a\d0\d\d)(?: b|\))/i], [f, [b, "OnePlus"], [h, y]], [/(alexa)webm/i, /(kf[a-z]{2}wi|aeo[c-r]{2})( bui|\))/i, /(kf[a-z]+)( bui|\)).+silk\//i], [f, [b, O], [h, _]], [/((?:sd|kf)[0349hijorstuw]+)( bui|\)).+silk\//i], [[f, /(.+)/g, "Fire Phone $1"], [b, O], [h, y]], [/(playbook);[-\w\),; ]+(rim)/i], [f, b, [h, _]], [/\b((?:bb[a-f]|st[hv])100-\d)/i, /\(bb10; (\w+)/i], [f, [b, N], [h, y]], [/(?:\b|asus_)(transfo[prime ]{4,10} \w+|eeepc|slider \w+|nexus 7|padfone|p00[cj])/i], [f, [b, C], [h, _]], [/ (z[bes]6[027][012][km][ls]|zenfone \d\w?)\b/i], [f, [b, C], [h, y]], [/(nexus 9)/i], [f, [b, "HTC"], [h, _]], [/(htc)[-;_ ]{1,2}([\w ]+(?=\)| bui)|\w+)/i, /(zte)[- ]([\w ]+?)(?: bui|\/|\))/i, /(alcatel|geeksphone|nexian|panasonic(?!(?:;|\.))|sony(?!-bra))[-_ ]?([-\w]*)/i], [b, [f, /_/g, " "], [h, y]], [/droid.+; ([ab][1-7]-?[0178a]\d\d?)/i], [f, [b, "Acer"], [h, _]], [/droid.+; (m[1-5] note) bui/i, /\bmz-([-\w]{2,})/i], [f, [b, "Meizu"], [h, y]], [/(blackberry|benq|palm(?=\-)|sonyericsson|acer|asus|dell|meizu|motorola|polytron)[-_ ]?([-\w]*)/i, /(hp) ([\w ]+\w)/i, /(asus)-?(\w+)/i, /(microsoft); (lumia[\w ]+)/i, /(lenovo)[-_ ]?([-\w]+)/i, /(jolla)/i, /(oppo) ?([\w ]+) bui/i], [b, f, [h, y]], [/(kobo)\s(ereader|touch)/i, /(archos) (gamepad2?)/i, /(hp).+(touchpad(?!.+tablet)|tablet)/i, /(kindle)\/([\w\.]+)/i, /(nook)[\w ]+build\/(\w+)/i, /(dell) (strea[kpr\d ]*[\dko])/i, /(le[- ]+pan)[- ]+(\w{1,9}) bui/i, /(trinity)[- ]*(t\d{3}) bui/i, /(gigaset)[- ]+(q\w{1,9}) bui/i, /(vodafone) ([\w ]+)(?:\)| bui)/i], [b, f, [h, _]], [/(surface duo)/i], [f, [b, L], [h, _]], [/droid [\d\.]+; (fp\du?)(?: b|\))/i], [f, [b, "Fairphone"], [h, y]], [/(u304aa)/i], [f, [b, "AT&T"], [h, y]], [/\bsie-(\w*)/i], [f, [b, "Siemens"], [h, y]], [/\b(rct\w+) b/i], [f, [b, "RCA"], [h, _]], [/\b(venue[\d ]{2,7}) b/i], [f, [b, "Dell"], [h, _]], [/\b(q(?:mv|ta)\w+) b/i], [f, [b, "Verizon"], [h, _]], [/\b(?:barnes[& ]+noble |bn[rt])([\w\+ ]*) b/i], [f, [b, "Barnes & Noble"], [h, _]], [/\b(tm\d{3}\w+) b/i], [f, [b, "NuVision"], [h, _]], [/\b(k88) b/i], [f, [b, "ZTE"], [h, _]], [/\b(nx\d{3}j) b/i], [f, [b, "ZTE"], [h, y]], [/\b(gen\d{3}) b.+49h/i], [f, [b, "Swiss"], [h, y]], [/\b(zur\d{3}) b/i], [f, [b, "Swiss"], [h, _]], [/\b((zeki)?tb.*\b) b/i], [f, [b, "Zeki"], [h, _]], [/\b([yr]\d{2}) b/i, /\b(dragon[- ]+touch |dt)(\w{5}) b/i], [[b, "Dragon Touch"], f, [h, _]], [/\b(ns-?\w{0,9}) b/i], [f, [b, "Insignia"], [h, _]], [/\b((nxa|next)-?\w{0,9}) b/i], [f, [b, "NextBook"], [h, _]], [/\b(xtreme\_)?(v(1[045]|2[015]|[3469]0|7[05])) b/i], [[b, "Voice"], f, [h, y]], [/\b(lvtel\-)?(v1[12]) b/i], [[b, "LvTel"], f, [h, y]], [/\b(ph-1) /i], [f, [b, "Essential"], [h, y]], [/\b(v(100md|700na|7011|917g).*\b) b/i], [f, [b, "Envizen"], [h, _]], [/\b(trio[-\w\. ]+) b/i], [f, [b, "MachSpeed"], [h, _]], [/\btu_(1491) b/i], [f, [b, "Rotor"], [h, _]], [/(shield[\w ]+) b/i], [f, [b, "Nvidia"], [h, _]], [/(sprint) (\w+)/i], [b, f, [h, y]], [/(kin\.[onetw]{3})/i], [[f, /\./g, " "], [b, L], [h, y]], [/droid.+; (cc6666?|et5[16]|mc[239][23]x?|vc8[03]x?)\)/i], [f, [b, q], [h, _]], [/droid.+; (ec30|ps20|tc[2-8]\d[kx])\)/i], [f, [b, q], [h, y]], [/smart-tv.+(samsung)/i], [b, [h, S]], [/hbbtv.+maple;(\d+)/i], [[f, /^/, "SmartTV"], [b, D], [h, S]], [/(nux; netcast.+smarttv|lg (netcast\.tv-201\d|android tv))/i], [[b, "LG"], [h, S]], [/(apple) ?tv/i], [b, [f, R + " TV"], [h, S]], [/crkey/i], [[f, E + "cast"], [b, M], [h, S]], [/droid.+aft(\w)( bui|\))/i], [f, [b, O], [h, S]], [/\(dtv[\);].+(aquos)/i, /(aquos-tv[\w ]+)\)/i], [f, [b, $], [h, S]], [/(bravia[\w ]+)( bui|\))/i], [f, [b, V], [h, S]], [/(mitv-\w{5}) bui/i], [f, [b, U], [h, S]], [/Hbbtv.*(technisat) (.*);/i], [b, f, [h, S]], [/\b(roku)[\dx]*[\)\/]((?:dvp-)?[\d\.]*)/i, /hbbtv\/\d+\.\d+\.\d+ +\([\w\+ ]*; *([\w\d][^;]*);([^;]*)/i], [[b, X], [f, X], [h, S]], [/\b(android tv|smart[- ]?tv|opera tv|tv; rv:)\b/i], [[h, S]], [/(ouya)/i, /(nintendo) ([wids3utch]+)/i], [b, f, [h, w]], [/droid.+; (shield) bui/i], [f, [b, "Nvidia"], [h, w]], [/(playstation [345portablevi]+)/i], [f, [b, V], [h, w]], [/\b(xbox(?: one)?(?!; xbox))[\); ]/i], [f, [b, L], [h, w]], [/((pebble))app/i], [b, f, [h, x]], [/(watch)(?: ?os[,\/]|\d,\d\/)[\d\.]+/i], [f, [b, R], [h, x]], [/droid.+; (glass) \d/i], [f, [b, M], [h, x]], [/droid.+; (wt63?0{2,3})\)/i], [f, [b, q], [h, x]], [/(quest( 2| pro)?)/i], [f, [b, B], [h, x]], [/(tesla)(?: qtcarbrowser|\/[-\w\.]+)/i], [b, [h, P]], [/(aeobc)\b/i], [f, [b, O], [h, P]], [/droid .+?; ([^;]+?)(?: bui|\) applew).+? mobile safari/i], [f, [h, y]], [/droid .+?; ([^;]+?)(?: bui|\) applew).+?(?! mobile) safari/i], [f, [h, _]], [/\b((tablet|tab)[;\/]|focus\/\d(?!.+mobile))/i], [[h, _]], [/(phone|mobile(?:[;\/]| [ \w\/\.]*safari)|pda(?=.+windows ce))/i], [[h, y]], [/(android[-\w\. ]{0,9});.+buil/i], [f, [b, "Generic"]]], engine: [[/windows.+ edge\/([\w\.]+)/i], [m, [g, "EdgeHTML"]], [/webkit\/537\.36.+chrome\/(?!27)([\w\.]+)/i], [m, [g, "Blink"]], [/(presto)\/([\w\.]+)/i, /(webkit|trident|netfront|netsurf|amaya|lynx|w3m|goanna)\/([\w\.]+)/i, /ekioh(flow)\/([\w\.]+)/i, /(khtml|tasman|links)[\/ ]\(?([\w\.]+)/i, /(icab)[\/ ]([23]\.[\d\.]+)/i, /\b(libweb)/i], [g, m], [/rv\:([\w\.]{1,9})\b.+(gecko)/i], [m, g]], os: [[/microsoft (windows) (vista|xp)/i], [g, m], [/(windows) nt 6\.2; (arm)/i, /(windows (?:phone(?: os)?|mobile))[\/ ]?([\d\.\w ]*)/i, /(windows)[\/ ]?([ntce\d\. ]+\w)(?!.+xbox)/i], [g, [m, Z, J]], [/(win(?=3|9|n)|win 9x )([nt\d\.]+)/i], [[g, "Windows"], [m, Z, J]], [/ip[honead]{2,4}\b(?:.*os ([\w]+) like mac|; opera)/i, /ios;fbsv\/([\d\.]+)/i, /cfnetwork\/.+darwin/i], [[m, /_/g, "."], [g, "iOS"]], [/(mac os x) ?([\w\. ]*)/i, /(macintosh|mac_powerpc\b)(?!.+haiku)/i], [[g, H], [m, /_/g, "."]], [/droid ([\w\.]+)\b.+(android[- ]x86|harmonyos)/i], [m, g], [/(android|webos|qnx|bada|rim tablet os|maemo|meego|sailfish)[-\/ ]?([\w\.]*)/i, /(blackberry)\w*\/([\w\.]*)/i, /(tizen|kaios)[\/ ]([\w\.]+)/i, /\((series40);/i], [g, m], [/\(bb(10);/i], [m, [g, N]], [/(?:symbian ?os|symbos|s60(?=;)|series60)[-\/ ]?([\w\.]*)/i], [m, [g, "Symbian"]], [/mozilla\/[\d\.]+ \((?:mobile|tablet|tv|mobile; [\w ]+); rv:.+ gecko\/([\w\.]+)/i], [m, [g, I + " OS"]], [/web0s;.+rt(tv)/i, /\b(?:hp)?wos(?:browser)?\/([\w\.]+)/i], [m, [g, "webOS"]], [/watch(?: ?os[,\/]|\d,\d\/)([\d\.]+)/i], [m, [g, "watchOS"]], [/crkey\/([\d\.]+)/i], [m, [g, E + "cast"]], [/(cros) [\w]+(?:\)| ([\w\.]+)\b)/i], [[g, G], m], [/panasonic;(viera)/i, /(netrange)mmh/i, /(nettv)\/(\d+\.[\w\.]+)/i, /(nintendo|playstation) ([wids345portablevuch]+)/i, /(xbox); +xbox ([^\);]+)/i, /\b(joli|palm)\b ?(?:os)?\/?([\w\.]*)/i, /(mint)[\/\(\) ]?(\w*)/i, /(mageia|vectorlinux)[; ]/i, /([kxln]?ubuntu|debian|suse|opensuse|gentoo|arch(?= linux)|slackware|fedora|mandriva|centos|pclinuxos|red ?hat|zenwalk|linpus|raspbian|plan 9|minix|risc os|contiki|deepin|manjaro|elementary os|sabayon|linspire)(?: gnu\/linux)?(?: enterprise)?(?:[- ]linux)?(?:-gnu)?[-\/ ]?(?!chrom|package)([-\w\.]*)/i, /(hurd|linux) ?([\w\.]*)/i, /(gnu) ?([\w\.]*)/i, /\b([-frentopcghs]{0,5}bsd|dragonfly)[\/ ]?(?!amd|[ix346]{1,2}86)([\w\.]*)/i, /(haiku) (\w+)/i], [g, m], [/(sunos) ?([\w\.\d]*)/i], [[g, "Solaris"], m], [/((?:open)?solaris)[-\/ ]?([\w\.]*)/i, /(aix) ((\d)(?=\.|\)| )[\w\.])*/i, /\b(beos|os\/2|amigaos|morphos|openvms|fuchsia|hp-ux|serenityos)/i, /(unix) ?([\w\.]*)/i], [g, m]] }, ee = function(e2, t2) {
              if (typeof e2 === c && (t2 = e2, e2 = s2), !(this instanceof ee)) return new ee(e2, t2).getResult();
              var r2 = typeof a2 !== u && a2.navigator ? a2.navigator : s2, n2 = e2 || (r2 && r2.userAgent ? r2.userAgent : ""), o3 = r2 && r2.userAgentData ? r2.userAgentData : s2, i3 = t2 ? F(Q, t2) : Q, w2 = r2 && r2.userAgent == n2;
              return this.getBrowser = function() {
                var e3, t3 = {};
                return t3[g] = s2, t3[m] = s2, Y.call(t3, n2, i3.browser), t3[p] = typeof (e3 = t3[m]) === d ? e3.replace(/[^\d\.]/g, "").split(".")[0] : s2, w2 && r2 && r2.brave && typeof r2.brave.isBrave == l && (t3[g] = "Brave"), t3;
              }, this.getCPU = function() {
                var e3 = {};
                return e3[v] = s2, Y.call(e3, n2, i3.cpu), e3;
              }, this.getDevice = function() {
                var e3 = {};
                return e3[b] = s2, e3[f] = s2, e3[h] = s2, Y.call(e3, n2, i3.device), w2 && !e3[h] && o3 && o3.mobile && (e3[h] = y), w2 && "Macintosh" == e3[f] && r2 && typeof r2.standalone !== u && r2.maxTouchPoints && r2.maxTouchPoints > 2 && (e3[f] = "iPad", e3[h] = _), e3;
              }, this.getEngine = function() {
                var e3 = {};
                return e3[g] = s2, e3[m] = s2, Y.call(e3, n2, i3.engine), e3;
              }, this.getOS = function() {
                var e3 = {};
                return e3[g] = s2, e3[m] = s2, Y.call(e3, n2, i3.os), w2 && !e3[g] && o3 && "Unknown" != o3.platform && (e3[g] = o3.platform.replace(/chrome os/i, G).replace(/macos/i, H)), e3;
            ...
            ee.VERSION = "1.0.35", ee.BROWSER = z([g, m, p]), ee.CPU = z([v]), ee.DEVICE = z([f, b, h, w, y, S, _, x, P]), ee.ENGINE = ee.OS = z([g, m]), typeof i2 !== u ? (o2.exports && (i2 = o2.exports = ee), i2.UAParser = ee) : r.amdO ? void 0 !== (n = function() {
              return ee;
      ...
      let o = r(703), i = { url: (e2) => e2.url, header: (e2, t2) => e2.headers.get(t2) };
      async function a(e2, t2) {
        let { url: r2, method: o2, headers: i2, body: a2, cache: s2, credentials: l2, integrity: u, mode: c, redirect: d, referrer: p, referrerPolicy: f } = t2;
        ...
        }()]], body: a2 ? n.from(await t2.arrayBuffer()).toString("base64") : null, cache: s2, credentials: l2, integrity: u, mode: c, redirect: d, referrer: p, referrerPolicy: f } };
      }
      ...
      "use strict";
      var n = r(942), o = Symbol.for("react.element"), i = Symbol.for("react.fragment"), a = Object.prototype.hasOwnProperty, s = n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, l = { key: true, ref: true, __self: true, __source: true };
      function u(e2, t2, r2) {
        var n2, i2 = {}, u2 = null, c = null;
        for (n2 in void 0 !== r2 && (u2 = "" + r2), void 0 !== t2.key && (u2 = "" + t2.key), void 0 !== t2.ref && (c = t2.ref), t2) a.call(t2, n2) && !l.hasOwnProperty(n2) && (i2[n2] = t2[n2]);
        if (e2 && e2.defaultProps) for (n2 in t2 = e2.defaultProps) void 0 === i2[n2] && (i2[n2] = t2[n2]);
        return { $$typeof: o, type: e2, key: u2, ref: c, props: i2, _owner: s.current };
      }
      t.Fragment = i, t.jsx = u, t.jsxs = u;
    }, 222: (e, t) => {
      "use strict";
      var r = Symbol.for("react.element"), n = Symbol.for("react.portal"), o = Symbol.for("react.fragment"), i = Symbol.for("react.strict_mode"), a = Symbol.for("react.profiler"), s = Symbol.for("react.provider"), l = Symbol.for("react.context"), u = Symbol.for("react.forward_ref"), c = Symbol.for("react.suspense"), d = Symbol.for("react.memo"), p = Symbol.for("react.lazy"), f = Symbol.iterator, g = { isMounted: function() {
        return false;
      ...
      function m(e2, t2, r2) {
        this.props = e2, this.context = t2, this.refs = b, this.updater = r2 || g;
      }
      function v() {
      }
      function w(e2, t2, r2) {
      ...
      y.constructor = w, h(y, m.prototype), y.isPureReactComponent = true;
      var _ = Array.isArray, S = Object.prototype.hasOwnProperty, x = { current: null }, P = { key: true, ref: true, __self: true, __source: true };
      function O(e2, t2, n2) {
        var o2, i2 = {}, a2 = null, s2 = null;
        if (null != t2) for (o2 in void 0 !== t2.ref && (s2 = t2.ref), void 0 !== t2.key && (a2 = "" + t2.key), t2) S.call(t2, o2) && !P.hasOwnProperty(o2) && (i2[o2] = t2[o2]);
        var l2 = arguments.length - 2;
        if (1 === l2) i2.children = n2;
        else if (1 < l2) {
          for (var u2 = Array(l2), c2 = 0; c2 < l2; c2++) u2[c2] = arguments[c2 + 2];
          i2.children = u2;
        }
        if (e2 && e2.defaultProps) for (o2 in l2 = e2.defaultProps) void 0 === i2[o2] && (i2[o2] = l2[o2]);
        return { $$typeof: r, type: e2, key: a2, ref: s2, props: i2, _owner: x.current };
      }
      function R(e2) {
      ...
      function T(e2, t2, o2) {
        ...
        var i2 = [], a2 = 0;
        return !function e3(t3, o3, i3, a3, s2) {
          var l2, u2, c2, d2 = typeof t3;
          ...
          if (p2) return s2 = s2(p2 = t3), t3 = "" === a3 ? "." + N(p2, 0) : a3, _(s2) ? (i3 = "", null != t3 && (i3 = t3.replace(C, "$&/") + "/"), e3(s2, o3, i3, "", function(e4) {
            return e4;
          })) : null != s2 && (R(s2) && (l2 = s2, u2 = i3 + (!s2.key || p2 && p2.key === s2.key ? "" : ("" + s2.key).replace(C, "$&/") + "/") + t3, s2 = { $$typeof: r, type: l2.type, key: u2, ref: l2.ref, props: l2.props, _owner: l2._owner }), o3.push(s2)), 1;
          if (p2 = 0, a3 = "" === a3 ? "." : a3 + ":", _(t3)) for (var g2 = 0; g2 < t3.length; g2++) {
            var h2 = a3 + N(d2 = t3[g2], g2);
            p2 += e3(d2, o3, i3, h2, s2);
          }
          else if ("function" == typeof (h2 = null === (c2 = t3) || "object" != typeof c2 ? null : "function" == typeof (c2 = f && c2[f] || c2["@@iterator"]) ? c2 : null)) for (t3 = h2.call(t3), g2 = 0; !(d2 = t3.next()).done; ) h2 = a3 + N(d2 = d2.value, g2++), p2 += e3(d2, o3, i3, h2, s2);
          else if ("object" === d2) throw Error("Objects are not valid as a React child (found: " + ("[object Object]" === (o3 = String(t3)) ? "object with keys {" + Object.keys(t3).join(", ") + "}" : o3) + "). If you meant to render a collection of children, use an array instead.");
          return p2;
        }(e2, i2, "", "", function(e3) {
          return t2.call(o2, e3, a2++);
        }), i2;
      }
      function E(e2) {
        if (-1 === e2._status) {
      ...
      t.Children = { map: T, forEach: function(e2, t2, r2) {
        T(e2, function() {
        ...
        return e2;
      } }, t.Component = m, t.Fragment = o, t.Profiler = a, t.PureComponent = w, t.StrictMode = i, t.Suspense = c, t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = { ReactCurrentDispatcher: I, ReactCurrentBatchConfig: M, ReactCurrentOwner: x }, t.act = A, t.cloneElement = function(e2, t2, n2) {
        if (null == e2) throw Error("React.cloneElement(...): The argument must be a React element, but you passed " + e2 + ".");
        var o2 = h({}, e2.props), i2 = e2.key, a2 = e2.ref, s2 = e2._owner;
        if (null != t2) {
          if (void 0 !== t2.ref && (a2 = t2.ref, s2 = x.current), void 0 !== t2.key && (i2 = "" + t2.key), e2.type && e2.type.defaultProps) var l2 = e2.type.defaultProps;
          for (u2 in t2) S.call(t2, u2) && !P.hasOwnProperty(u2) && (o2[u2] = void 0 === t2[u2] && void 0 !== l2 ? l2[u2] : t2[u2]);
        }
        var u2 = arguments.length - 2;
        if (1 === u2) o2.children = n2;
        else if (1 < u2) {
          l2 = Array(u2);
          for (var c2 = 0; c2 < u2; c2++) l2[c2] = arguments[c2 + 2];
          o2.children = l2;
        }
        return { $$typeof: r, type: e2.type, key: i2, ref: a2, props: o2, _owner: s2 };
      ...
      }, t.createElement = O, t.createFactory = function(e2) {
        var t2 = O.bind(null, e2);
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|admin|_next|images|favicon.ico|icon.png|robots.txt|sitemap.xml|manifest.webmanifest).*))(.json)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": {}, "webpack": null, "eslint": { "ignoreDuringBuilds": true }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.mjs", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "analyticsId": "", "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "inline", "remotePatterns": [], "unoptimized": true }, "devIndicators": { "buildActivity": true, "buildActivityPosition": "bottom-right" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "optimizeFonts": true, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "httpAgentOptions": { "keepAlive": true }, "outputFileTracing": true, "staticPageGenerationTimeout": 60, "swcMinify": true, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "experimental": { "prerenderEarlyExit": false, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 1, "memoryBasedWorkersCount": false, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "outputFileTracingRoot": "/workspaces/ozy-fi", "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "adjustFontFallbacks": false, "adjustFontFallbacksWithSizeAdjust": false, "typedRoutes": false, "instrumentationHook": false, "bundlePagesExternals": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "missingSuspenseWithCSRBailout": true, "optimizeServerReact": true, "useEarlyImport": false, "staleTimes": { "dynamic": 30, "static": 300 }, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "configFileName": "next.config.mjs" };
var BuildId = "aZ2n3ZBSSOcUAGZupjSGh";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/admin/dashboard", "regex": "^/admin/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/dashboard(?:/)?$" }, { "page": "/admin/kitchen", "regex": "^/admin/kitchen(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/kitchen(?:/)?$" }, { "page": "/icon.png", "regex": "^/icon\\.png(?:/)?$", "routeKeys": {}, "namedRegex": "^/icon\\.png(?:/)?$" }, { "page": "/manifest.webmanifest", "regex": "^/manifest\\.webmanifest(?:/)?$", "routeKeys": {}, "namedRegex": "^/manifest\\.webmanifest(?:/)?$" }, { "page": "/robots.txt", "regex": "^/robots\\.txt(?:/)?$", "routeKeys": {}, "namedRegex": "^/robots\\.txt(?:/)?$" }, { "page": "/sitemap.xml", "regex": "^/sitemap\\.xml(?:/)?$", "routeKeys": {}, "namedRegex": "^/sitemap\\.xml(?:/)?$" }], "dynamic": [{ "page": "/api/admin/coupons/[code]", "regex": "^/api/admin/coupons/([^/]+?)(?:/)?$", "routeKeys": { "nxtPcode": "nxtPcode" }, "namedRegex": "^/api/admin/coupons/(?<nxtPcode>[^/]+?)(?:/)?$" }, { "page": "/api/admin/orders/[id]", "regex": "^/api/admin/orders/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/orders/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/admin/staff/[id]", "regex": "^/api/admin/staff/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/staff/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/admin/[table]", "regex": "^/api/admin/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtable": "nxtPtable" }, "namedRegex": "^/api/admin/(?<nxtPtable>[^/]+?)(?:/)?$" }, { "page": "/api/admin/[table]/[id]", "regex": "^/api/admin/([^/]+?)/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtable": "nxtPtable", "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/(?<nxtPtable>[^/]+?)/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/orders/[orderNum]", "regex": "^/api/orders/([^/]+?)(?:/)?$", "routeKeys": { "nxtPorderNum": "nxtPorderNum" }, "namedRegex": "^/api/orders/(?<nxtPorderNum>[^/]+?)(?:/)?$" }, { "page": "/images/[...key]", "regex": "^/images/(.+?)(?:/)?$", "routeKeys": { "nxtPkey": "nxtPkey" }, "namedRegex": "^/images/(?<nxtPkey>.+?)(?:/)?$" }, { "page": "/[locale]", "regex": "^/([^/]+?)(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)(?:/)?$" }, { "page": "/[locale]/menu", "regex": "^/([^/]+?)/menu(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/menu(?:/)?$" }, { "page": "/[locale]/menu/[category]", "regex": "^/([^/]+?)/menu/([^/]+?)(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale", "nxtPcategory": "nxtPcategory" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/menu/(?<nxtPcategory>[^/]+?)(?:/)?$" }, { "page": "/[locale]/privacy", "regex": "^/([^/]+?)/privacy(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/privacy(?:/)?$" }, { "page": "/[locale]/product/[id]", "regex": "^/([^/]+?)/product/([^/]+?)(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale", "nxtPid": "nxtPid" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/product/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/[locale]/terms", "regex": "^/([^/]+?)/terms(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/terms(?:/)?$" }, { "page": "/[locale]/track", "regex": "^/([^/]+?)/track(?:/)?$", "routeKeys": { "nxtPlocale": "nxtPlocale" }, "namedRegex": "^/(?<nxtPlocale>[^/]+?)/track(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/icon.png": { "initialHeaders": { "cache-control": "public, immutable, no-transform, max-age=31536000", "content-type": "image/png", "x-next-cache-tags": "_N_T_/layout,_N_T_/icon.png/layout,_N_T_/icon.png/route,_N_T_/icon.png" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/icon.png", "dataRoute": null }, "/manifest.webmanifest": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "application/manifest+json", "x-next-cache-tags": "_N_T_/layout,_N_T_/manifest.webmanifest/layout,_N_T_/manifest.webmanifest/route,_N_T_/manifest.webmanifest" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/manifest.webmanifest", "dataRoute": null }, "/robots.txt": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "text/plain", "x-next-cache-tags": "_N_T_/layout,_N_T_/robots.txt/layout,_N_T_/robots.txt/route,_N_T_/robots.txt" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/robots.txt", "dataRoute": null }, "/admin/dashboard": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/dashboard", "dataRoute": "/admin/dashboard.rsc" }, "/admin/kitchen": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/kitchen", "dataRoute": "/admin/kitchen.rsc" }, "/admin": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin", "dataRoute": "/admin.rsc" } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "bb9efd7ecdfc551102771f3cc7d09773", "previewModeSigningKey": "4ea508aeab6c292d18b5056856b066560c166155b4077ca5adec032d61d7410f", "previewModeEncryptionKey": "fa5959f6aa949233b31b5228037cec0482eb8550bfc0213bdfe23dde3b2568dd" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["prerender-manifest.js", "server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|admin|_next|images|favicon.ico|icon.png|robots.txt|sitemap.xml|manifest.webmanifest).*))(.json)?[\\/#\\?]?$", "originalSource": "/((?!api|admin|_next|images|favicon.ico|icon.png|robots.txt|sitemap.xml|manifest.webmanifest).*)" }], "wasm": [], "assets": [], "environments": { "previewModeId": "bb9efd7ecdfc551102771f3cc7d09773", "previewModeSigningKey": "4ea508aeab6c292d18b5056856b066560c166155b4077ca5adec032d61d7410f", "previewModeEncryptionKey": "fa5959f6aa949233b31b5228037cec0482eb8550bfc0213bdfe23dde3b2568dd" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/icon.png/route": "/icon.png", "/manifest.webmanifest/route": "/manifest.webmanifest", "/robots.txt/route": "/robots.txt", "/api/admin/2fa/confirm/route": "/api/admin/2fa/confirm", "/api/admin/2fa/disable/route": "/api/admin/2fa/disable", "/api/admin/2fa/status/route": "/api/admin/2fa/status", "/api/admin/2fa/setup/route": "/api/admin/2fa/setup", "/api/admin/activity/route": "/api/admin/activity", "/api/admin/change-password/route": "/api/admin/change-password", "/api/admin/[table]/route": "/api/admin/[table]", "/api/admin/coupons/route": "/api/admin/coupons", "/api/admin/coupons/[code]/route": "/api/admin/coupons/[code]", "/api/admin/login/verify-2fa/route": "/api/admin/login/verify-2fa", "/api/admin/login/route": "/api/admin/login", "/api/admin/logout/route": "/api/admin/logout", "/api/admin/me/route": "/api/admin/me", "/api/admin/orders/route": "/api/admin/orders", "/api/admin/staff/[id]/route": "/api/admin/staff/[id]", "/api/admin/settings/route": "/api/admin/settings", "/api/admin/staff/route": "/api/admin/staff", "/api/admin/upload/route": "/api/admin/upload", "/api/coupons/validate/route": "/api/coupons/validate", "/api/orders/[orderNum]/route": "/api/orders/[orderNum]", "/api/menu/route": "/api/menu", "/api/orders/route": "/api/orders", "/api/orders/by-phone/route": "/api/orders/by-phone", "/images/[...key]/route": "/images/[...key]", "/sitemap.xml/route": "/sitemap.xml", "/api/admin/[table]/[id]/route": "/api/admin/[table]/[id]", "/api/admin/analytics/route": "/api/admin/analytics", "/api/admin/orders/[id]/route": "/api/admin/orders/[id]", "/(site)/[locale]/privacy/page": "/[locale]/privacy", "/(site)/[locale]/track/page": "/[locale]/track", "/(site)/[locale]/terms/page": "/[locale]/terms", "/(site)/[locale]/product/[id]/page": "/[locale]/product/[id]", "/admin/dashboard/page": "/admin/dashboard", "/admin/kitchen/page": "/admin/kitchen", "/admin/page": "/admin", "/(site)/[locale]/menu/[category]/page": "/[locale]/menu/[category]", "/(site)/[locale]/page": "/[locale]", "/(site)/[locale]/menu/page": "/[locale]/menu" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/api/admin/2fa/confirm": {}, "/api/admin/2fa/disable": {}, "/api/admin/2fa/setup": {}, "/api/admin/2fa/status": {}, "/api/admin/[table]/[id]": {}, "/api/admin/activity": {}, "/api/admin/analytics": {}, "/api/admin/coupons/[code]": {}, "/api/admin/coupons": {}, "/api/admin/login/verify-2fa": {}, "/api/admin/logout": {}, "/api/admin/me": {}, "/api/admin/orders/[id]": {}, "/api/admin/orders": {}, "/api/admin/change-password": {}, "/api/admin/staff/[id]": {}, "/api/admin/staff": {}, "/api/admin/upload": {}, "/api/admin/[table]": {}, "/api/menu": {}, "/api/orders/[orderNum]": {}, "/api/orders/by-phone": {}, "/api/admin/login": {}, "/images/[...key]": {}, "/sitemap.xml": {}, "/[locale]/menu/[category]": {}, "/api/admin/settings": {}, "/[locale]": {}, "/[locale]/product/[id]": {}, "/api/coupons/validate": {}, "/api/orders": {}, "/[locale]/menu": {} } };
